...
public class SynapseMeasuresSingleCell extends JFrame implements
	...
	private SynapseMeasuresSingleCellCntrMarkerVector markerVector;
	private SynapseMeasuresSingleCellCntrMarkerVector currentMarkerVector;
	...
	private SynapseMeasuresSingleCellCntrImageCanvas ic;
	...
	static SynapseMeasuresSingleCell instance;
	

	public SynapseMeasuresSingleCell() {
		super("Synapse Measures Single Cell");
	...
	void populateTxtFields() {
		...
		while (it.hasNext()) {
			...
			SynapseMeasuresSingleCellCntrMarkerVector markerVector = (SynapseMeasuresSingleCellCntrMarkerVector) it
					.next();
	...
	private JRadioButton makeDynRadioButton(int id) {
		...
		markerVector = new SynapseMeasuresSingleCellCntrMarkerVector(id);
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (command.compareTo(INITIALIZE) == 0) {
			...
			currentMarkerVector = (SynapseMeasuresSingleCellCntrMarkerVector) typeVector
					.get(index - 1);
	...
	public void finalMeasure() {
		try {
			...
			File f1 = new File("SynapseRatiosSingleCell.txt");
			f1.delete();
			File f2 = new File("SynapseMeasuresSingleCell.txt");
			f2.delete();
	...
	public void reset() {
		...
		while (mit.hasNext()) {
			SynapseMeasuresSingleCellCntrMarkerVector mv = (SynapseMeasuresSingleCellCntrMarkerVector) mit.next();
			mv.clear();
		}
		if (ic != null)
			ic.repaint();
	...
	public void loadMarkers() {
		...
		if (storedfilename.equals(img.getTitle())) {
			...
			currentMarkerVector = (SynapseMeasuresSingleCellCntrMarkerVector) typeVector.get(index);
			ic.setCurrentMarkerVector(currentMarkerVector);
	...
	public SynapseMeasuresSingleCellCntrMarkerVector getCurrentMarkerVector() {
		return currentMarkerVector;
	}

	public void setCurrentMarkerVector(final SynapseMeasuresSingleCellCntrMarkerVector currentMarkerVector) {
	...
	public static void setType(String type) {
		...
		if (index < 0 || index >= buttons)
			return;
		final JRadioButton rbutton = (JRadioButton) instance.dynRadioVector
				.elementAt(index);
		instance.radioGrp.setSelected(rbutton.getModel(), true);
		instance.currentMarkerVector = (SynapseMeasuresSingleCellCntrMarkerVector) instance.typeVector
				.get(index);
