 ...
 * @author Kurt De Vos
 */
public class SynapseMeasuresSingleCellCntrImageCanvas extends ImageCanvas{
    private Vector typeVector;
    private SynapseMeasuresSingleCellCntrMarkerVector currentMarkerVector;
    private SynapseMeasuresSingleCell cc;
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (!delmode){
            SynapseMeasuresSingleCellCntrMarker m = new SynapseMeasuresSingleCellCntrMarker(x, y, img.getCurrentSlice());
            currentMarkerVector.addMarker(m);
        }else{
        	SynapseMeasuresSingleCellCntrMarker m = currentMarkerVector.getMarkerFromPosition(new Point(x,y) ,img.getCurrentSlice());
    ...
    public void paint(Graphics g){
        ...
        */
        ...
        while(it.hasNext()){
        	SynapseMeasuresSingleCellCntrMarkerVector mv = (SynapseMeasuresSingleCellCntrMarkerVector)it.next();
    ...
    public void measure(){
    	try {
    		...
    		FileOutputStream rawData=new FileOutputStream(
    				...
    				(new File("SynapseMeasuresSingleCell.txt")).exists());
	        ...
	        while(it.hasNext()){
	            ...
	            case 2: typeLabel="Tsyn"; break;
	            case 3: typeLabel="Tnosyn"; break;
	            }
	            ListIterator mit = mv.listIterator();
	    	...
	    	IJ.write("Tsyn\t"+" "+(mu[1]+mu[2])+" "+"\t"+" "+Math.sqrt(sigma2[1]+sigma2[2]));
	    	IJ.write("Tnosyn\t"+" "+mu[2]+" "+"\t"+" "+Math.sqrt(sigma2[2]));
	        IJ.write(" ");
	        IJ.write("Ratio\t"+" "+ratio);

    		FileOutputStream ratioData=new FileOutputStream(
    				"SynapseRatiosSingleCell.txt",
    				(new File("SynapseRatiosSingleCell.txt")).exists());
    ...
    public void setCurrentMarkerVector(SynapseMeasuresSingleCellCntrMarkerVector currentMarkerVector) {
